...
public:
    ...
    void testContactWithEnergyTransmitter() {
        ...
        auto energy_ball = world->getEnergyBalls().at(0);
        float e_transm_2_x = energy_ball->getPositionX();
        float e_transm_2_y = energy_ball->getPositionY() - ENRG_BALL_RADIUS -
                ENRG_TRANSM_HALF_HEIGHT - 1;
        float time_elapsed = 0; // Contabilizo tiempo vida bola energia
        bool ball_deleted = false;
    ...
    void testContactWithEnergyBall() {
        ...
        float e_transm_2_x = e_transm_x + 4 * ENRG_BALL_RADIUS +
                2 * ENRG_TRANSM_HALF_WIDTH + 2;
    ...
    void testContactWithEnergyBarrier() {
        ...
        float barrier_x = e_transm_x + 4 * ENRG_BALL_RADIUS +
    ...
    void testContactWithOpenGate() {
        ...
        float gate_x = e_ball->getPositionX() + ENRG_BALL_RADIUS +
                GATE_HALF_WIDTH + 2;
